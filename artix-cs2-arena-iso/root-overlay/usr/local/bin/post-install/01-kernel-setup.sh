...
# Install linux-zen (gaming-optimized PREEMPT kernel)
echo "==> [CS2-Arena] Installing linux-zen..."
pacman -Sy --noconfirm linux-zen linux-zen-headers 2>/dev/null || {
    echo "  [WARN] linux-zen install failed. Can be installed later with:"
    echo "         pacman -S linux-zen linux-zen-headers"
}

echo "==> [CS2-Arena] Rebuilding initramfs..."
